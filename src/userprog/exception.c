...
page_fault (struct intr_frame *f) 
{
  ...
  /* Variable for handle_mm_fault() check */
  bool load = false;
  ...
  {  
    ...
    if (not_present) /* Check if physical page fault */
    {
      ...
      /* If entry exists, load data into physical memory and mapping. */
      if(entry)
      { 
        /* If this address is requested to write but entry is readonly, fail. */
